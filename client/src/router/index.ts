...
const router = createRouter({
    ...
    routes: [
        ...
        },
        {
            path: '/bd-library/',
            name: 'BDLibrary Home',
            component: () => import('@/views/BDLibrary/Home.vue'),
        },
        {
            path: '/bd-library/search',
            name: 'BDLibrary Search',
            component: () => import('@/views/BDLibrary/Search.vue'),
        },
        {
            path: '/bd-library/watch/:id',
            name: 'BDLibrary Watch',
            component: () => import('@/views/BDLibrary/Watch.vue'),
        },
