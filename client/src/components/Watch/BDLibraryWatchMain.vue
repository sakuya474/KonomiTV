<template>
    <div class="route-container">
        <main class="watch-container" :class="{
                ...
                'watch-container--bdlibrary': true,
            }">
            <WatchNavigation />
            <div class="watch-content"
                 ...
                 @click="playerStore.event_emitter.emit('SetControlDisplayTimer', {event: $event, is_player_region_event: true})">
                        <BDLibraryWatchHeader :playback_mode="playback_mode" />
        <BDLibraryWatchPlayer :playback_mode="playback_mode" />
    </div>
    <BDLibraryWatchPanel :playback_mode="playback_mode" />
        </main>
...
import BDLibraryWatchHeader from '@/components/Watch/BDLibraryWatchHeader.vue';
import BDLibraryWatchPanel from '@/components/Watch/BDLibraryWatchPanel.vue';
import BDLibraryWatchPlayer from '@/components/Watch/BDLibraryWatchPlayer.vue';
import usePlayerStore from '@/stores/PlayerStore';
import useSettingsStore from '@/stores/SettingsStore';
import Utils from '@/utils';

// BD視聴専用の視聴画面（録画視聴画面のUIを使用）
export default defineComponent({
    name: 'BDLibraryWatchMain',
    components: {
        KeyboardShortcutList,
        BDLibraryWatchHeader,
        WatchNavigation,
        BDLibraryWatchPanel,
        BDLibraryWatchPlayer,
    },
    props: {
        playback_mode: {
